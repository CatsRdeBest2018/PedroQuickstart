    ...
    public void buildPaths() {
        Shot1 = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(115.446, 125.988)),
                        mirrorRedToBlue(new Pose(84.703, 92.028))
                ))
        ...
        Intake1Setup = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(90.338, 83.054)),
                        mirrorRedToBlue(new Pose(93, 59))
                ))
        ...
        Intake1 = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(93, 57)),
                        mirrorRedToBlue(new Pose(126.819, 57))
                ))
        ...
        Shot2 = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(126.819, 56.378)),
                        mirrorRedToBlue(new Pose(87.231, 82.871))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
//
...
//                .build();
        ...
        Intake3 = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(90.231, 82.454)),
                        mirrorRedToBlue(new Pose(114, 81.914))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(114, 81.914)),
                        mirrorRedToBlue(new Pose(90.301, 82.336))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        park = follower.pathBuilder()
                .addPath(new BezierLine(
                        mirrorRedToBlue(new Pose(90.231, 82.871)),
                        mirrorRedToBlue(new Pose(95, 75))
                ))
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
    }
